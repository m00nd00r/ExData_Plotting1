...
# Fourth Plot:
        ...
        with(power3,plot(DateTime,Global_active_power,type="l",xlab="",ylab="Global Active Power"))

        with(power3,plot(DateTime,Voltage,type="l",xlab="",ylab="Voltage"))
        ...
        with(power3,plot(DateTime,Global_reactive_power,type="l",xlab="",ylab="Global Reactive Power"))
